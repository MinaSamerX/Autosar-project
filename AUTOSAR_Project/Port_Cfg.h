 ...
 *                          Pins Initialization                                *
 *******************************************************************************/
#define PORTA_PIN0_INITIALIZATION          (STD_ON)
#define PORTA_PIN1_INITIALIZATION          (STD_ON)
#define PORTA_PIN2_INITIALIZATION          (STD_ON)
#define PORTA_PIN3_INITIALIZATION          (STD_ON)
#define PORTA_PIN4_INITIALIZATION          (STD_ON)
#define PORTA_PIN5_INITIALIZATION          (STD_ON)
#define PORTA_PIN6_INITIALIZATION          (STD_ON)
#define PORTA_PIN7_INITIALIZATION          (STD_ON)

#define PORTB_PIN0_INITIALIZATION          (STD_ON)
#define PORTB_PIN1_INITIALIZATION          (STD_ON)
#define PORTB_PIN2_INITIALIZATION          (STD_ON)
#define PORTB_PIN3_INITIALIZATION          (STD_ON)
#define PORTB_PIN4_INITIALIZATION          (STD_ON)
#define PORTB_PIN5_INITIALIZATION          (STD_ON)
#define PORTB_PIN6_INITIALIZATION          (STD_ON)
#define PORTB_PIN7_INITIALIZATION          (STD_ON)

#define PORTC_PIN0_INITIALIZATION          (STD_ON)
#define PORTC_PIN1_INITIALIZATION          (STD_ON)
#define PORTC_PIN2_INITIALIZATION          (STD_ON)
#define PORTC_PIN3_INITIALIZATION          (STD_ON)
#define PORTC_PIN4_INITIALIZATION          (STD_ON)
#define PORTC_PIN5_INITIALIZATION          (STD_ON)
#define PORTC_PIN6_INITIALIZATION          (STD_ON)
#define PORTC_PIN7_INITIALIZATION          (STD_ON)

#define PORTD_PIN0_INITIALIZATION          (STD_ON)
#define PORTD_PIN1_INITIALIZATION          (STD_ON)
#define PORTD_PIN2_INITIALIZATION          (STD_ON)
#define PORTD_PIN3_INITIALIZATION          (STD_ON)
#define PORTD_PIN4_INITIALIZATION          (STD_ON)
#define PORTD_PIN5_INITIALIZATION          (STD_ON)
#define PORTD_PIN6_INITIALIZATION          (STD_ON)
#define PORTD_PIN7_INITIALIZATION          (STD_ON)

#define PORTE_PIN0_INITIALIZATION          (STD_ON)
#define PORTE_PIN1_INITIALIZATION          (STD_ON)
#define PORTE_PIN2_INITIALIZATION          (STD_ON)
#define PORTE_PIN3_INITIALIZATION          (STD_ON)
#define PORTE_PIN4_INITIALIZATION          (STD_ON)
#define PORTE_PIN5_INITIALIZATION          (STD_ON)
...
#define PORTE_PIN2_DATA_TYPE       (DIGITAL)
#define PORTE_PIN3_DATA_TYPE       (DIGITAL)
